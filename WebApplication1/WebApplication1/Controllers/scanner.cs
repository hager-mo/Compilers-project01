...
namespace WebApplication1.Controllers
{
    public class Scanner
    {
        ...
        private void initializer()
        {
            ...
            ReservedWords.Add("Ipok", TokenType.Type);
            ReservedWords.Add("Spok", TokenType.Type);
            ReservedWords.Add("Craf", TokenType.Type);
            ReservedWords.Add("Sequence", TokenType.Type);
            ReservedWords.Add("Ipokf", TokenType.Type);
            ReservedWords.Add("SIpokf", TokenType.Type);
            ReservedWords.Add("Valueless", TokenType.Type);
            ReservedWords.Add(" Rational", TokenType.Type);


            ReservedWords.Add("break", TokenType.Break);
            ReservedWords.Add("however", TokenType.However);
            ReservedWords.Add("when", TokenType.When);
            ReservedWords.Add("erturn", TokenType.Return);
            ReservedWords.Add("struct", TokenType.Struct);
            ReservedWords.Add("scan", TokenType.Scan);


            Operators.Add("@", TokenType.StartSymbols);
            Operators.Add("^", TokenType.StartSymbols);
            Operators.Add("$", TokenType.EndSymbols);
            Operators.Add("#", TokenType.EndSymbols);
